...
image WMAM STYLE = Composite(
    ...
    (0,0), ConditionSwitch(
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'home'", "images/Sprite/wmam/wmam body_wear home.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'under'", "images/Sprite/wmam/wmam body_wear under.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'sleep'", "images/Sprite/wmam/wmam body_wear sleep.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'casual'", "images/Sprite/wmam/wmam body_wear casual.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'school'", "images/Sprite/wmam/wmam body_wear school.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'school_swim'", "images/Sprite/wmam/wmam body_wear school_swim.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'school_sport'", "images/Sprite/wmam/wmam body_wear school_sport.webp",
        "len(WChar.gvar('wmam', 'achiev_wear')) > 0 and WChar.avar('wmam', 'achiev_wear', a_menu_8) == 'soap'", "images/Sprite/wmam/wmam body_wear soap.webp",
        "True", Null()
    ),
    (0,0), "WMAM HEADFG",
    )
...
image HPAP STYLE = Composite(
    ...
    (0,0), "HPAP HEAD",
    (0,0), ConditionSwitch(
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'home'", "images/Sprite/hpap/hpap body_wear home.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'under'", "images/Sprite/hpap/hpap body_wear under.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'sleep'", "images/Sprite/hpap/hpap body_wear sleep.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'casual'", "images/Sprite/hpap/hpap body_wear casual.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'school'", "images/Sprite/hpap/hpap body_wear school.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'school_swim'", "images/Sprite/hpap/hpap body_wear school_swim.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'school_sport'", "images/Sprite/hpap/hpap body_wear school_sport.webp",
        "len(WChar.gvar('hpap', 'achiev_wear')) > 0 and WChar.avar('hpap', 'achiev_wear', a_menu_8) == 'soap'", "images/Sprite/hpap/hpap body_wear soap.webp",
        "True", Null()
    ),
    )
